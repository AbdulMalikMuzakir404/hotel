    ...
    <div class="login-box">
        ...
        <div class="card">
            ...
            <form action="{{ route('login') }}" method="post">
                <figure><img src="{{ asset("storage/images/logo_aplikasi.png") }}" alt="logo" class="rounded-circle img-responsive" width="200" height="200"></figure>
                <p class="login-box-msg mb-3">Kehadiranmu adalah anugerah bagi kami</p>
                @csrf
                ...
                <div class="px-2 mt-3">
                <button type="submit" style="background: #2F5D62; color: rgb(255, 255, 255);" class="btn-block mx-auto rounded-pill">Masuk</button>
                </div>
